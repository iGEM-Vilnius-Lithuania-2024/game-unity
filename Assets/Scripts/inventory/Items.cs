...
public class Items
{
    ...
    {
        { new Tuple<int, int>(0, 0), new OriItem("<i>F1</i> ori\n(level 1)", "Short DNA sequence that lets plasmids make 1 copies of themselves.", "items/0_0", 1.5f) },
        { new Tuple<int, int>(0, 1), new OriItem("<i>RK2</i> ori\n(level 2)", "Short DNA sequence that lets plasmids make 5 copies of themselves.", "items/0_1", 2f) },
        { new Tuple<int, int>(0, 2), new OriItem("<i>p15A</i> ori\n(level 3)", "Short DNA sequence that lets plasmids make 30 copies of themselves.", "items/0_2", 2.5f) },
        { new Tuple<int, int>(0, 3), new OriItem("<i>pMB1</i> ori\n(level 4)", "Short DNA sequence that lets plasmids make more than 200 copies of themselves.", "items/0_3", 3f) },
        ...
        { new Tuple<int, int>(2, 1), new GeneItem("<i>Cry</i> gene\n(level 2)", "The <i>cry</i> gene produces Cry toxins, which are like tiny poison crystals for pests.", "items/2_1", ItemAttribute.Attack, 3, "items/attack") },
        { new Tuple<int, int>(2, 2), new GeneItem("<i>Cry</i> gene\n(level 3)", "The <i>cry</i> gene produces Cry toxins, which are like tiny poison crystals for pests.", "items/2_2", ItemAttribute.Attack, 4, "items/attack") },
        { new Tuple<int, int>(2, 3), new GeneItem("<i>Cry</i> gene\n(level 4)", "The <i>cry</i> gene produces Cry toxins, which are like tiny poison crystals for pests.", "items/2_3", ItemAttribute.Attack, 5, "items/attack") },
        ...
        { new Tuple<int, int>(3, 1), new GeneItem("<i>NifH</i> gene\n(level 2)", "The <i>nifH</i> gene makes a hardworking iron protein found in the cytoplasm of nitrogen-fixing bacteria. It fuels nitrogenase with energy to convert nitrogen gas into usable ammonia for growth!", "items/3_1", ItemAttribute.HP, 15, "items/hp") },
        { new Tuple<int, int>(3, 2), new GeneItem("<i>NifH</i> gene\n(level 3)", "The <i>nifH</i> gene makes a hardworking iron protein found in the cytoplasm of nitrogen-fixing bacteria. It fuels nitrogenase with energy to convert nitrogen gas into usable ammonia for growth!", "items/3_2", ItemAttribute.HP, 20, "items/hp") },
        { new Tuple<int, int>(3, 3), new GeneItem("<i>NifH</i> gene\n(level 4)", "The <i>nifH</i> gene makes a hardworking iron protein found in the cytoplasm of nitrogen-fixing bacteria. It fuels nitrogenase with energy to convert nitrogen gas into usable ammonia for growth!", "items/3_3", ItemAttribute.HP, 25, "items/hp") },
        ...
        { new Tuple<int, int>(4, 1), new GeneItem("<i>Spo0A</i> gene\n(level 2)", "The <i>spo0A</i> gene encodes a protein that is the key player in starting sporulation when the food runs out. It helps bacteria to survive harsh conditions.", "items/4_1", ItemAttribute.Regen, 1.5f, "items/hp_regen") },
        { new Tuple<int, int>(4, 2), new GeneItem("<i>Spo0A</i> gene\n(level 3)", "The <i>spo0A</i> gene encodes a protein that is the key player in starting sporulation when the food runs out. It helps bacteria to survive harsh conditions.", "items/4_2", ItemAttribute.Regen, 2, "items/hp_regen") },
        { new Tuple<int, int>(4, 3), new GeneItem("<i>Spo0A</i> gene\n(level 4)", "The <i>spo0A</i> gene encodes a protein that is the key player in starting sporulation when the food runs out. It helps bacteria to survive harsh conditions.", "items/4_3", ItemAttribute.Regen, 2.5f, "items/hp_regen") },
    };
}